...
<div id="wrapper">
    ...
    >
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url().'admin/pegawai/'.$this->session->userdata('penduduk_id');?>">
          <i class="fa fa-users" aria-hidden="true"></i>
          <span>Data Pegawai</span></a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url().'admin/mitra/'.$this->session->userdata('penduduk_id');?>">
