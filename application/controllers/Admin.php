...
*/
	function mitra(){
		...
		$data['data']=$this->m_dah->get_data_desc('id','mitra')->result();
		$this->load->view('admin/v_header');
		$this->load->view('admin/sistem/mitra_data',$data);
		$this->load->view('admin/v_footer');
	}
	 ...
	 function mitra_add(){
		...
		$this->load->view('admin/v_header');
		$this->load->view('admin/sistem/mitra_add');
		$this->load->view('admin/v_footer');
	 }
	...
	function mitra_act(){
		...
		$this->form_validation->set_rules('nama','Data harus terisi','required');
		$this->form_validation->set_rules('pemilik','Data harus terisi','required');
		$this->form_validation->set_rules('alamat','Data harus terisi','required');
		$this->form_validation->set_rules('email','Data harus terisi','required');
		$this->form_validation->set_rules('no_hp','Data harus terisi','required');


		if($this->form_validation->run() != true){
			 redirect(base_url().'admin/mitra_add');
		}else{
			...
			redirect(base_url().'admin/mitra/?alert=add');
 	...
 	function mitra_view($id){
			$this->load->database();
			$where=array(
				'id' =>	$id
			);
			$data['data']=$this->m_dah->edit_data($where,'mitra')->result();
			
			$this->load->view('admin/v_header');
			$this->load->view('admin/sistem/mitra_view',$data);
			$this->load->view('admin/v_footer');

		}

		function mitra_edit($id){
			$this->load->database();
			$where=array(
				'id' =>	$id
			);
			...
			$this->load->view('admin/v_header');
			$this->load->view('admin/sistem/mitra_edit',$data);
			$this->load->view('admin/v_footer');

		}

        function mitra_update(){
			$this->load->database();
            $this->form_validation->set_rules('nama','Data harus terisi','required');
            $this->form_validation->set_rules('pemilik','Data harus terisi','required');
            $this->form_validation->set_rules('alamat','Data harus terisi','required');
			...
			if($this->form_validation->run() != true){
				...
				$this->m_dah->update_data($where,$data_pd,'mitra');

				redirect(base_url().'admin/mitra/?alert=update');

			}
			
		}

         function mitra_delete($id){
			$this->load->database();
			if($id == ""){
				redirect('base_url()');
			}else{
				...
				$this->m_dah->delete_data($where,'mitra');

				redirect('admin/mitra/?alert=post-delete');
			}
		}
...
*/
	...
	function perusahaan(){
		...
		$data['data']=$this->m_dah->get_data_desc('id','perusahaan')->result();
		$this->load->view('admin/v_header');
		$this->load->view('admin/sistem/perusahaan_data',$data);
		$this->load->view('admin/v_footer');
	}
	 ...
	 function perusahaan_add(){
		...
		$this->load->view('admin/v_header');
		$this->load->view('admin/sistem/perusahaan_add');
		$this->load->view('admin/v_footer');
	 }

	 function perusahaan_act(){
	 	$this->load->database();

		$this->form_validation->set_rules('nama','Data harus terisi','required');
		$this->form_validation->set_rules('bidang','Data harus terisi','required');
		$this->form_validation->set_rules('alamat','Data harus terisi','required');


		if($this->form_validation->run() != true){
			 redirect(base_url().'admin/perusahaan_add');
		}else{
			...
			redirect(base_url().'admin/perusahaan/?alert=add');
 	...
 	function perusahaan_view($id){
			$this->load->database();
			$where=array(
				'id' =>	$id
			);
			$data['data']=$this->m_dah->edit_data($where,'perusahaan')->result();
			
			$this->load->view('admin/v_header');
			$this->load->view('admin/sistem/perusahaan_view',$data);
			$this->load->view('admin/v_footer');

		}

		function perusahaan_edit($id){
			$this->load->database();
			$where=array(
				'id' =>	$id
			);
			...
			$this->load->view('admin/v_header');
			$this->load->view('admin/sistem/perusahaan_edit',$data);
			$this->load->view('admin/v_footer');
        ...
        function perusahaan_update(){
			...
			if($this->form_validation->run() != true){
				...
				$this->m_dah->update_data($where,$data_pd,'perusahaan');

				redirect(base_url().'admin/perusahaan/?alert=update');
         ...
         function perusahaan_delete($id){
			...
			if($id == ""){
				...
				$this->m_dah->delete_data($where,'perusahaan');

				redirect('admin/perusahaan/?alert=post-delete');
			}
		}
